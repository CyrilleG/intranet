...
import controllers.AppGroupController;
...
privileged aspect AppGroupController_Roo_Controller {
    
    @RequestMapping(method = RequestMethod.POST, produces = "text/html")
    public String AppGroupController.create(@Valid AppGroup appGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String AppGroupController.createForm(Model uiModel) {
        populateEditForm(uiModel, new AppGroup());
        return "appgroups/create";
    }
    
    @RequestMapping(value = "/{idgroup}", produces = "text/html")
    public String AppGroupController.show(@PathVariable("idgroup") Integer idgroup, Model uiModel) {
    ...
    public String AppGroupController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String AppGroupController.update(@Valid AppGroup appGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, appGroup);
    ...
    public String AppGroupController.updateForm(@PathVariable("idgroup") Integer idgroup, Model uiModel) {
    ...
    public String AppGroupController.delete(@PathVariable("idgroup") Integer idgroup, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void AppGroupController.populateEditForm(Model uiModel, AppGroup appGroup) {
    ...
    String AppGroupController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
