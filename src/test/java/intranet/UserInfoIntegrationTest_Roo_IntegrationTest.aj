...
privileged aspect UserInfoIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserInfoIntegrationTest.testFindUserInfo() {
        ...
        Assert.assertEquals("Find method for 'UserInfo' returned the incorrect identifier", id, obj.getInfo());
    }
    ...
    public void UserInfoIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'UserInfo' identifier to be null", obj.getInfo());
        obj.persist();
        obj.flush();
        Assert.assertNotNull("Expected 'UserInfo' identifier to no longer be null", obj.getInfo());
    }
