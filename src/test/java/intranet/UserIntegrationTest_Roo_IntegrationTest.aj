...
import intranet.UserIntegrationTest;
...
privileged aspect UserIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserIntegrationTest.testFindUser() {
        ...
        Assert.assertEquals("Find method for 'User' returned the incorrect identifier", id, obj.getIduser());
    }
    ...
    public void UserIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'User' identifier to be null", obj.getIduser());
        obj.persist();
        obj.flush();
        Assert.assertNotNull("Expected 'User' identifier to no longer be null", obj.getIduser());
    }
